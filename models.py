"""
LUXE COLLECTIVE - SQLAlchemy Models
"""
...
class UserPreference(Base):
    ...
    preferred_categories = Column(String, nullable=True)  # JSON string
    preferred_designers = Column(String, nullable=True)   # JSON string
